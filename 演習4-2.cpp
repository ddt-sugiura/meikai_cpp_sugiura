...
int main() {
	...
	//最大値になるまでループ
	//for (int Int_go8 = 0; Int_go8 < INT_MAX ; Int_go8++) {　本来のfor分
	...
	cout << "int型10進行\n";
	//最大値になるまでループ
	//for (int Int_go10 = 0; Int_go10 < INT_MAX ; Int_go10++) {　本来のfor分
	...
	cout << "unsigned型8進行\n";
	//最大値になるまでループ
	//for (int UnsignInt_go8 = 0; UnsignInt_go8 < UINT_MAX ; UnsignInt_go8++) {　本来のfor分
	...
	cout << "unsigned型10進行\n";
	//最大値になるまでループ
	//for (int UnsignInt_go10 = 0; UnsignInt_go10 < UINT_MAX ; UnsignInt_go10++) {　本来のfor分
	...
	cout << "unsigned型16進行\n";
	//最大値になるまでループ
	//for (int UnsignInt_go16 = 0; UnsignInt_go16 < UINT_MAX ; UnsignInt_go16++) {　本来のfor分
